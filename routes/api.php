...
Route::delete('/user/{id}', [UserController::class, 'deleteUser'])
    ->middleware(['auth:api', 'role:admin']); // Hanya admin yang bisa mengakses
...
Route::middleware('auth:api', 'role:admin')->post('/presensi/analysis-time', [PresenceController::class, 'analyzeAttendanceByTime']);
